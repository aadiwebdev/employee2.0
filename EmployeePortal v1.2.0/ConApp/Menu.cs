...
namespace ConApp
{
    class Menu
    {
        ...
        /// <returns></returns>
        public List<IModel> DisplayUsers(UserRoleChoice userRoleChoice)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IModel ReadRegisterData()
        {
            Console.Write("\nEnter First Name:- ");
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case (int)UserSelectionChoice.GetUserDetails:
                        ...
                        List<IModel> usersList = DisplayUsers((UserRoleChoice)userChoice);
